...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p c23456b8-1aef-4bcd-ad02-ae7cf312391b
```

> `c23456b8-1aef-4bcd-ad02-ae7cf312391b` is the password of the certificate, you can change it to any password you want.
